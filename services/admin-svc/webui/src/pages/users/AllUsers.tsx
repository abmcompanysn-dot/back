...
// Module Utilisateurs — vue unifiée des trois types de comptes que le
// système gère (clients acheteurs, boutiques/vendeurs, admins du
// back-office), chacun dans son propre service (auth-svc/vendor-svc) mais
// affichés ici comme un seul écran avec un sélecteur d'onglet, plutôt que
// 3 pages disjointes sans lien entre elles.
type Tab = 'customers' | 'vendors' | 'admins'
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h2>Utilisateurs</h2>
          <p className="subtitle">Clients, boutiques et comptes admin — {total} au total sur cet onglet</p>
        </div>
      </div>
      ...
      {tab !== 'admins' && (
        <div className="filters-bar">
          <input
            ...
            placeholder={tab === 'customers' ? 'Rechercher par email, téléphone, nom…' : 'Rechercher par nom ou email…'}
            value={query}
      ...
      {!loading && !error && tab !== 'admins' && total > PAGE_SIZE && (
