...
#   https://github.com/abmcompanysn-dot/back
#
...
# Réutilisable : ne recommit pas à vide, repousse origin/main.
# ============================================================
set -euo pipefail

REMOTE="https://github.com/abmcompanysn-dot/back.git"
...
say "Dépôt publié : https://github.com/abmcompanysn-dot/back"
